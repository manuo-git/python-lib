# name: Min Sparse Table 2D
# prefix: sparsetable2dmin
# ---
class MinDisjointSparseTable2D:
    def __init__(self, A: list[list[int]]):
        ...
        self.st = [MAX_VAL] * size
        
        tmp_x = [MAX_VAL] * (self.log_n * self.N * self.M)
